...
<section className="p-8">
  <div className="max-w-7xl mx-auto border-2 rounded-3xl border bg-white/10">
    ...
    <div className="text-white-30 p-10 leading-relaxed mb-10">
      ...
      La PSU trova il suo posto nella seconda camera del case, dietro alla scheda madre, e il dissipatore viene montato sulla CPU dopo aver spremuto una piccola quantità di pasta termica tra il processore e il plate del primo, questo serve per condurre la maggior quantità di calore dalla CPU al dissipatore possibile, il radiatore invece l'ho inserito di lato, se lo avessi montato sopra avrebbe aspirato aria calda per raffreddare il liquido, in basso invece avrei avuto problemi con la pompa del liquido. <br></br>
    ...
    <div className="flex flex-row justify-center gap-4 mb-10 px-10">
      <img
        src="/fase31.webp"
        alt="fase3"
        className="w-1/2 h-full object-cover rounded-3xl border-3 border-blue-400"
      />
      <img
        src="/fase32.webp"
        alt="fase3"
...
<section className="p-8">
  <div className="max-w-7xl mx-auto border-2 rounded-3xl border bg-white/10">
    ...
    <div className="p-8 flex flex-col gap-4 mb-10">
      ...
      <img
        src="/fase51.webp"
        alt="fase5"
        className="w-full object-cover rounded-3xl border-3 border-blue-400"
      />
    </div>
  </div>
</section>
